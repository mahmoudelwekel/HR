...
namespace HR
{
    public partial class departments : Form
    {
        ...
        void clearall()
        {
            try
            {
                this.departmentsTableAdapter.search(this.hRDataSet.departments, search_txt.Text);
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            try
            {
                if (name_txt.Text != "")
                {
                    ...
                    this.departmentsTableAdapter.Insert(name_txt.Text, adress_txt.Text);
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (dr != null)
                    {
                        ...
                        this.departmentsTableAdapter.Update(name_txt.Text, adress_txt.Text, id);
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (dr != null)
                    {
                        ...
                        this.departmentsTableAdapter.Delete(id);
