...
namespace HR
{
    public partial class holiday_types : Form
    {
        ...
        void clearall()
        {
            try
            {
                this.holiday_typeTableAdapter.search(this.hRDataSet.holiday_type, search_txt.Text);
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            try
            {
                if (name_txt.Text != "")
                {
                    ...
                    this.holiday_typeTableAdapter.Insert(name_txt.Text, Convert.ToBoolean( active_ch.CheckState));
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (dr != null)
                    {
                        ...
                        this.holiday_typeTableAdapter.Update(name_txt.Text, Convert.ToBoolean(active_ch.CheckState), id);
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (dr != null)
                    {
                        ...
                        this.holiday_typeTableAdapter.Delete(id);
