...
namespace HR
{
    public partial class rules : Form
    {
        ...
        void clearall()
        {
            try
            {
                this.rulesTableAdapter.search(this.hRDataSet.rules, search_txt.Text);
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            try
            {
                if (name_txt.Text != "")
                {
                    ...
                    this.rulesTableAdapter.Insert(name_txt.Text, adress_txt.Text);
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (dr != null)
                    {
                        ...
                        this.rulesTableAdapter.Update(name_txt.Text, adress_txt.Text, id);
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (dr != null)
                    {
                        ...
                        this.rulesTableAdapter.Delete(id);
